	...
	<div class="row">
		<div class="col-md-12 bloc article-bloc"></span>
			<div class="inner-bloc">
				...
				<a href="<?php Route::echo('NewArticle');?>" class="btn btn-sm btn-add">Ajouter un évenement</a></h1> 
				<header>
					...
					<ul class="inline group-action">
						<li><a 
							...
							<li><a class="<?php echo $filter==1?'active':''; ?>" 
								href="<?php Route::echo('AllArticles'); ?>/filter/1">  Plannifiés <?php echo $filter==1?'('.$elementNumber.')':''; ?> </a></li>
								<li><a class="<?php echo $filter==2?'active':''; ?>" 
									href="<?php Route::echo('AllArticles'); ?>/filter/2"> Passés <?php echo $filter==2?'('.$elementNumber.')':''; ?> </a></li>
									<li>
									</ul>
