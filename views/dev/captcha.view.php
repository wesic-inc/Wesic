...
for($i=0;$i<strlen($captcha);$i++){
	imagettftext($image, rand(38,45), rand(-20,20), 10+($i*rand(38,43)), rand(80,120), $color[rand(0,9)], 'public/fonts/'.$files[rand(0,count($files))],$captcha[$i]);
}
