							...
							<div class="row">
								<div class="col-md-12 theme-links">
									...
									<content>
										...
										<ul>
											<li><a href="#"> Voir nos templates Ready To Go</a></li>
											<li><a href="#"> Testez notre Theme Creator</a></li>
									...
									<div class="col-md-12 pub-links">
										...
										<content>
											<ul>
												<li><a href="#"> Créer votre premier article</a></li>
												<li><a href="#"> Ajouter une page A propos</a></li>
												<li><a href="#"> Créer un évènement</li>
												</ul>
												<ul>
										...
										<div class="col-lg-12 more-links">
											...
											<content>
												<ul>
													<li><a href="#">Personnaliser le menu</a></li>
													<li><a href="#">Option d’administration</a></li>
													<li><a href="#">Option d’administration</a></li>
												</ul>
											</content>
										</div>
