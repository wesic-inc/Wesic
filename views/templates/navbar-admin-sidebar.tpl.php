...
<?php endif; ?>
	...
	<div class="siteinfo">
		<a href="<?php echo Route::getAll('Admin'); ?>">
	...
	<ul class="nav" id="menu">
		<li class="<?php echo ($c == "admin" && $a == "index" )?"active":"";?>"><a href="<?php echo Route::getAll('Admin'); ?>"><span class="icon icon-home"></span><span class="link-text">Dashboard</span></a></li>
		<li class="dropdown-link <?php echo ($c == "article" && $a == "allArticles" )?"active":"";?>">
			...
			<div class="dropdown">
				<ul> 
					<li><a href="<?php Route::getAll('AllArticles'); ?>"> Tous les articles</a> </li> 
					<li><a href="<?php Route::getAll('AllArticles'); ?>">Ajouter un article</a> </li> 
					<li><a href="<?php Route::getAll('AllArticles'); ?>">Catégories</a> </li> 
					<li><a href="<?php Route::getAll('AllArticles'); ?>">Tags</a> </li> 
				</ul>
			</div>
		</li>
		<li class="dropdown-link <?php echo ($c == "comment" && $a == "index" )?"active":"";?>" ><a href="#"><span class="icon icon-file-empty"></span><span class="link-text">Pages<span class="icon-ctrl carret-down"></span></span></a>
			<div class="dropdown">
				<ul> 
					<li><a href="<?php Route::getAll('AllArticles'); ?>">Toutes les pages</a> </li> 
					<li><a href="<?php Route::getAll('AllArticles'); ?>">Ajouter une page</a> </li>  
				</ul>
			</div>
		</li>
		<li classs="<?php echo ($c == "comment" && $a == "index" )?"active":"";?>">
			<a href="<?php Route::getAll('AllArticles'); ?>">
		...
		<li class="dropdown-link" >
			...
			<div class="dropdown">
				<ul> 
					<li><a href="<?php Route::getAll('AllArticles'); ?>">Tous les événements</a> </li> 
					<li><a href="<?php Route::getAll('AllArticles'); ?>">Ajouter un événement</a> </li>  
				</ul>
			</div>
		</li>
		<li class="<?php echo ($c == "comment" && $a == "index" )?"active":"";?>">
			<a href="<?php Route::getAll('AllArticles'); ?>"><span class="icon icon-bubbles2"></span><span class="link-text">Commentaires</span></a>
		</li>
		...
		<li class="dropdown-link <?php echo ($c == "theme" && $a == "index" )?"active":"";?>"> 
			...
			<div class="dropdown">
				<ul> 
					<li><a href="<?php Route::getAll('AllArticles'); ?>">Modifier le thème</a> </li> 
					<li><a href="<?php Route::getAll('AllArticles'); ?>">Mes thèmes</a> </li>  
					<li><a href="<?php Route::getAll('AllArticles'); ?>">Theme Creator</a> </li>  
				</ul>
			</div></li>
			<li class="<?php echo ($c == "settings" && $a == "index" )?"active":"";?>">
				<a href="<?php Route::getAll('AllArticles'); ?>"><span class="icon icon-equalizer"></span><span class="link-text">Paramètres</span></a></li>
    </ul>
</div>
